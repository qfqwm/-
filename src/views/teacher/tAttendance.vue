      ...
      >
        ...
        <el-table-column label="操作">
          <template #default>
            ...
            >
            <el-button type="text" size="small"
              ><router-link to="/tedit">处理</router-link></el-button
            >
          </template>
        </el-table-column>
      </el-table>
...
<script lang='ts'>
import { gettAttendance } from "@/api/index";
...
export default {
  setup() {
    ...
    const object = reactive({ collegeName: "", projectName:"",proName:"", grades:"",classes:"",attendanceStatus:"", stuId: "",
       stuRealname:""
})
    //查询
    const test = () => {
   ...
   stuid.value = "",
    ...
    const getData = function () {
      axios;
      gettAttendance(object).then(function (res) {
