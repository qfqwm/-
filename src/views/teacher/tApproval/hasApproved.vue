  ...
  <div class="locat">
    ...
    <div class="result">
      <el-table :data="tableData">
        ...
        <el-table-column prop="jobTheme" label="作业主题" width="160" />
        <el-table-column prop="jobType" label="作业类型" width="160" />
        <el-table-column prop="trainingTeacher" label="实训老师" width="80" />
        <el-table-column prop="releaseTime" label="发布时间" width="120" />
        <el-table-column prop="planComTime" label="计划完成时间" width="120" />
        ...
        <el-table-column label="操作" width="100">
          ...
          <template #default>
            ...
            <router-link to="/dotask">详情</router-link></el-button>
        </template>
        </el-table-column>
      </el-table>
    </div>
...
import { getHasApproved} from "@/api/index";
const value = ref("");
const tag=ref(false);
const options = ref()
const pro = ref('')
