  ...
  <div class="locat">
    ...
    <div class="result">
       <el-table :data="tableData">
        <el-table-column prop="collegeName" label="院系" width="220"/>
        <el-table-column prop="projectName" label="项目名称" width="220" />
        <el-table-column prop="teacherName" label="责任老师" width="220" />
        <el-table-column prop="groupName" label="小组" width="220" />
        <el-table-column prop="leader" label="小组长" width="220" />
        <el-table-column prop="projectMember" label="项目成员" width="220" />
        <!-- <el-table-column prop="num1" label="学号" width="150"/>
        <el-table-column prop="name6" label="项目角色" width="170"/>
        <el-table-column prop="name7" label="1" width="100"/> -->
        <el-table-column label="操作" width="100">
          <!-- <el-button><router-link to="/dowork">操作</router-link></el-button> -->
        <template #default>
            <el-button type="text" size="small">
            <router-link to="/tgradex-edit">操作</router-link></el-button>
        </template>
        </el-table-column>
      </el-table>
    </div>
