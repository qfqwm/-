  ...
  <div class="locat">
    ...
    <el-row class="titleStyle">
      <el-button type="primary" class="tit">
        <router-link to="/aGrade">个人评分</router-link></el-button>
      
      <el-button type="primary" class="tit">
        <router-link to="/aGradex">小组评分</router-link></el-button>
    </el-row>
    <!-- 按需查询 -->
    <div class="SearchBar">
    ...
    <div class="result">
       <el-table :data="tableData">
        ...
        <el-table-column prop="personalScore" label="综合评分" width="150"/>
        <el-table-column label="作业评分" width="100">
          <!-- <el-button><router-link to="/dowork">操作</router-link></el-button> -->
        <template #default>
            <el-button type="text" size="small">
            <router-link to="/aGrade-edit">操作</router-link></el-button>
        </template>
        </el-table-column>
      </el-table>
    </div>
