  ...
  <div class="locat">
    ...
    <div class="header-1">
      ...
      <div class="blockTask">
        <span>审批人：</span>
        <!-- <el-cascader :options="entryname1" /> -->
        <el-select v-model="teacherName1" placeholder="请选择">
          <el-option
            v-for="item in teacherName1s"
            :key="item.value"
            :label="item.lable"
            :value="item.value"
          />
    ...
    <div class="showdata">
      ...
      >
        ...
        <el-table-column
          prop="studentInfo.projectGroup.projectTeam.project.teacher.teacherName"
          label="审批人"
        />
        <el-table-column label="操作">
          <template #default="aaaa">
            <el-button
              ...
              ><router-link :to="{name:'anotpass',params:{'stuId':JSON.stringify(aaaa.row)}}">详情</router-link></el-button
            >
          </template>
        </el-table-column>
      </el-table>
...
import { getaleave } from "@/api/index";
export default {
  setup() {
    //查询
    const test = () => {
      ...
      object.teacherName = teacherName1.value;
    ...
    const getData = function () {
      getaleave(object).then(function (res) {
        // console.log(res);
        console.log(object);
