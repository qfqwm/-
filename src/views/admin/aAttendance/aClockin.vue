<template>
  <div class="locat">
    ...
    <div class="header">
      <div class="block">
        <span>日期：</span>
        <el-date-picker  type="date" :default-value="new Date(2010, 9, 1)" />
      </div>
      <div class="block">
        <span>学号：</span>
    ...
    <div class="header-1">
      <el-upload class="upload-demo" 
        ...
        :auto-upload="false">
        <el-button class="down" size="small" type="primary">导入文档</el-button>
      </el-upload>
       <el-button class="down" size="small" type="primary" >下载模板</el-button>
       <el-button class="down" size="small" type="primary" >导出文档</el-button>
       
    </div>

    <div class="showdata">
      <el-table :data="tableData" :header-cell-style="{ color: '#FFF', background: '#6168fe' }">
...
<script lang='ts'>
import {getaClockin} from "@/api/index";
  ...
  setup() {
    ...
    const attendancetype = [
     ...
     const loadData= async function () {
      ...
      //  const save=function(){
      //       axios;
      //       Downloadtemplate().then(function (res) {
      //          console.log(res)
