  ...
  <div class="locat">
    ...
    <div class="result">
       <el-table :data="tableData">
        <el-table-column prop="collegeName" label="院系" width="190"/>
        <el-table-column prop="projectName" label="项目名称" width="190" />
        <el-table-column prop="teacherName" label="责任老师" width="190" />
        <el-table-column prop="groupName" label="小组" width="190" />
        <el-table-column prop="leader" label="小组长" width="190" />
        <el-table-column prop="projectMember" label="项目成员" width="190" />
        <el-table-column prop="personalScore" label="综合评分" width="190"/>
        <el-table-column label="作业评分" width="100">
          <!-- <el-button><router-link to="/dowork">操作</router-link></el-button> -->
        <template #default>
            <el-button type="text" size="small">
            <router-link to="/aGradex-edit">操作</router-link></el-button>
        </template>
        </el-table-column>
      </el-table>
    </div>
