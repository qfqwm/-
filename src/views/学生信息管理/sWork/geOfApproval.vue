  ...
  <div class="locat">
    ...
    <div class="result">
      <el-table :data="tableData">
        ...
        <el-table-column prop="stuStatusName" label="计划完成状态" width="150"/>
        <el-table-column prop="actualComTime" label="实际完成时间" width="170"/>
        <el-table-column prop="homScore" label="得分" width="100"/>
...
import { getGoOfApproval} from "@/api/index";
import { ref} from "vue";
const ttt = ref("");
...
const getData =() => {
  getGoOfApproval(object).then((res) => {
    console.log(res.data.data);
    if(object.homeTitle!=""){
      res.data.data.pageHomeworks.list.forEach((p) => {
        if(p.homTitle==object.homeTitle){
