  ...
  <div class="locat">
    ...
    <div class="SearchBar">
      ...
      <div class="Search">
        ...
        <el-select class="m-2" placeholder="项目名称：" size="large" v-model="Pro">
          <el-option v-for="item in pro" :key="item" :label="item" :value="item" />
        </el-select>
      </div>

      <div class="Search">
        <span>作业主题：</span>
        <el-select class="m-2" placeholder="作业主题：" size="large" v-model="taskTheme">
          <el-option
      ...
      <div class="Search">
        <span>作业类型：</span>
        <el-select class="m-2" placeholder="作业类型：" size="large" v-model="taskType">
          <el-option
      ...
      <div class="Search">
        ...
        <el-select v-model="Tea" class="m-2" placeholder="老师：" size="large"
          >
          <el-option
            v-for="item in tea"
            :key="item"
    ...
    <div class="result">
      <el-table :data="tableData">
        ...
        <el-table-column prop="stuFile" label="计划完成状态" width="150" />
        <el-table-column prop="homEndTime" label="实际完成时间" width="170" />
        <el-table-column prop="stuFile" label="得分" width="100" />
        <el-table-column label="操作" width="100">
          <template #default>
            <el-button type="text" size="small">
              <router-link to="/dowork">操作</router-link></el-button
            >
          </template>
        </el-table-column>
      </el-table>
...
const getData =() => {
  getTeacher(object).then((res) => {
    console.log(res.data.data);
    // if(res.data.flag==object.homeTitle){
    //   return tableData.value=[{homTitle:"111"}]
    // }
    // tableData.value=[{homTitle:"111"}]
