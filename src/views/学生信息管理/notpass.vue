  ...
  <div class="locat">
    <div class="header">
      <div class="table">
        ...
        :auto-upload="false">
        <el-button class="down" size="small" type="primary">上传附件</el-button>
      </el-upload>
    ...
    <div class="footer">
      <div class="showdata">
        <el-table :data="tableData">
          <el-table-column prop="studentInfo" label="操作人" width="380" />
          <el-table-column prop="name" label="操作事项" width="380" />
          <el-table-column prop="address" label="操作时间" />
          <el-table-column prop="address1" label="说明" />
        </el-table>
      </div>
          ...
          <el-form-item>
            <el-button type="primary">
              <img
                ...
                class="buttonimg"
              />
              <router-link to="/sLeave">确定</router-link>
            </el-button>
            <el-button id="reset">
              <img
...
export default {
  setup() {
    ...
    console.log(JSON.parse(route.params.stuId.toString()).studentInfo.projectGroup.projectTeam.project.teacher.teacherName);
    ...
    // const tableData = ref("");  //操作记录
    const tableData = [
      {
        studentInfo:JSON.parse(route.params.stuId.toString()).studentInfo.projectGroup.projectTeam.project.teacher.teacherName,
        name:JSON.parse(route.params.stuId.toString()).leaveStatus,
        address:JSON.parse(route.params.stuId.toString()).startTime,
        address1:''
      }
    ]
    return {
