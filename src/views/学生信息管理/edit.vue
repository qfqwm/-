  ...
  <div class="locat">
    <div class="header">
      ...
      <div class="context">
        ...
        <input type="text" placeholder="审批人:" class="foot" v-model="ren" />
      </div>
    </div>
    <div class="footer">
      <div class="footer-1">
          ...
          <el-form-item>
            <el-button type="primary">
              <img
                ...
                class="buttonimg"
              />
              <router-link to="/sLeave" @click="sure">确定</router-link>
            </el-button>
            <el-button id="reset">
              <img
...
export default {
  setup() {
    ...
    onMounted(() => {
      ...
      data1.stuRealname = JSON.parse(
        route.params.stuId.toString()
      ).studentInfo.stuRealname;
      data1.stuId = JSON.parse(route.params.stuId.toString()).studentInfo.stuId;
      data1.collegeName = JSON.parse(
        route.params.stuId.toString()
      ).studentInfo.collegeName;
      data1.proName = JSON.parse(
        route.params.stuId.toString()
      ).studentInfo.proName;
      data1.stuGrade = JSON.parse(
        route.params.stuId.toString()
      ).studentInfo.stuGrade;
      data1.stuClass = JSON.parse(
        route.params.stuId.toString()
      ).studentInfo.stuClass;
      data1.teacherName = JSON.parse(
        route.params.stuId.toString()
      ).studentInfo.projectGroup.projectTeam.project.teacher.teacherName;
